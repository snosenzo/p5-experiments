...
class Particle {
    ...
    update() {
        ...
        if(dist(this.pos.x, this.pos.y, width/2, height/2) > circleRadius) {
            vel = sqVecFromNoise(this.pos.x, this.pos.y);
    ...
    display() {
        ...
        stroke(0,  map(this.pos.y,1250, 2750, 120, 10 ));
        strokeWeight(2);
        point(this.pos.x, ((this.pos.y-height/2) * sin(-PI/6) + height/2) + 600 * noise(this.pos.x/(noiseScale * 2),this.pos.y/(noiseScale * 2), nz));
    }
